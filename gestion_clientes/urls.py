...
urlpatterns = [
    ...
    path('switch-client/<str:client_id>/', views.switch_client_view, name='switch_client'),
    ...
    path('admin/clients/<uuid:cliente_id>/', views.admin_client_detail_view, name='admin_client_detail'),
